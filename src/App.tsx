...
const changelog = [
  {
    ...
    desc: '向邀请码注册的内测用户开放 AI 对话、AI 出题与知识树能力；加入请求安全闸门、AI 来源标识、使用限制与可一键切回的离线规则引擎。一项可撤回的内测 AI 数据授权同时覆盖本次生成和经安全筛选、脱敏、去身份化后的短表达离线资源改进。同步修复共创题库 TXT、DOCX、PDF 文件在手机端未真正发出的问题，并改进多轮上下文、足迹线程、装扮与提醒可靠性。',
  },
  {
    date: '2026-07-19',
    title: '朵朵切换为审核文案规则聊天',
