...
const features = [
  ...
  { icon: aiChatIcon, title: '朵朵规则聊天', desc: '回复由审核文案库、关键词规则与学习数据组合，不实时调用大模型；经单独授权的脱敏缺口可用于改进静态内容' },
...
const faq = [
  ...
  {
    q: '我的数据存在哪里？会交给第三方吗？',
    a: '账号、学习记录与聊天内容保存在我们的服务器上，服务器目前位于中国香港，属于个人信息出境。规则回复不把完整对话交给模型实时回答；仅当你另行开启 AI 数据授权时，无法匹配的短样例才可能在脱敏、聚合达到门槛后交给 DeepSeek，用于生成并复核静态内容候选。你可以随时关闭。我们计划在 huaix.cn 完成备案后迁回中国内地。详见隐私政策。',
  },
  {
    q: '我能导出或删除我的数据吗？',
        ...
        <section className="hero">
          <div className="hero-inner">
            ...
            <p className="ai-notice">
              📚 朵朵当前由审核文案库和规则自动回应，不实时调用云端大模型，也不是真人。经单独授权的脱敏缺口可能用于后台改进静态内容。内容仅供学习辅助，不能替代教材与专业医学判断。本服务仅面向年满 18 周岁的用户。
            </p>
